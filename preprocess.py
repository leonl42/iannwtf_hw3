...
if args.input is None:
    sys.exit("Please specify the loading directory for the datasets with -input when running preprocess.py")
    
# check if output path is given by the user
if args.output is None:
    sys.exit("Please specify the saving directory for the datasets with -output when running preprocess.py")
